...
const Home = () => {
  return (
    <>
      <Navbar />
      <section className="relative min-h-screen bg-[#050505] text-white overflow-fidden">
        {/* glow background*/}
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 pt-32 pb-20 text-center">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-3 px-4 py-2 mb-8 border border-white/10 rounded-full bg-white/5 backdrop-blur"
          >
          ...
          >
            Generate Stunning, responsive website instantaly using AI. No coding
            Required.
            <br /> Perfect for startups, creators and freelancers
          </motion.p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-20">
            <div className="p-6 rounded-2xl bg-white/5 border border-white/10 backdrop-blur hover:border-indigo-400 transition">
              ...
              <p className="text-sm text-gray-400">Describe you Website and AI generates it Instantly</p>
            </div>
            <div className="p-6 rounded-2xl bg-white/5 border border-white/10 backdrop-blur hover:border-indigo-400 transition">
              <LayoutTemplate className="text-indigo-400 mb-4"/>
              <h3 className="font-semibold text-lg mb-2">Responsive Layout</h3>
              <p className="text-sm text-gray-400">Websites Looks perfect on Mobile , Tablet and Desktop</p>
            </div>
            <div className="p-6 rounded-2xl bg-white/5 border border-white/10 backdrop-blur hover:border-indigo-400 transition">
